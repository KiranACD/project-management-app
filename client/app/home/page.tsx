...
const HomePage = () => {
    ...
    const {data: tasks, isLoading, isError} = useGetTasksQuery({projectId: parseInt("1")});
    const {data: projects, isLoading: isProjectsLoading, isError: isProjectsError} = useGetProjectsQuery();

    const isDarkMode = useAppSelector((state) => state.global.isDarkMode);

    if (isLoading || isProjectsLoading) return <div>Loading...</div>;
                ...
                <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={taskDistribution}>
                            ...
                            />
                            <Legend />
                            <Bar dataKey="count" fill={chartColors.text}/>
                        </BarChart>
                    </ResponsiveContainer>
                </div>
                <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary">
